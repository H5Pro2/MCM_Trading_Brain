...
class Config:
    ...
    MCM_FIELD_AGENTS = 48
    MCM_FIELD_DIMS = 3
    MCM_FIELD_LOCAL_NEIGHBORS = 8
    MCM_FIELD_COUPLING_SIGMA = 0.5
    MCM_COUPLING = 0.045
    MCM_NOISE = 0.08
    MCM_CENTER_FORCE = 0.0100
    MCM_CLUSTER_EVERY_N_TICKS = 2
    MCM_CLUSTER_EPS = 0.4
    MCM_CLUSTER_MIN_SAMPLES = 4
    ...
    MCM_INNER_TICKS_PER_WORLD_TICK = 1
    MCM_INNER_IDLE_BASE_TICKS = 1
    MCM_INNER_IDLE_MAX_TICKS = 2
    MCM_INNER_IDLE_SLEEP_MIN_SECONDS = 0.10
    MCM_INNER_IDLE_SLEEP_MAX_SECONDS = 0.45
    MCM_RUNTIME_TICKS_PER_WINDOW = 1
    MCM_RUNTIME_IDLE_TICKS = 1
    MCM_RUNTIME_IDLE_TICKS_MAX = 2
    MCM_RUNTIME_IDLE_SLEEP_MIN_SECONDS = 0.10
    MCM_RUNTIME_IDLE_SLEEP_MAX_SECONDS = 0.45
    MCM_MEMORY_STATE_PATH = "bot_memory/memory_state.json"
    MCM_MEMORY_SAVE_COOLDOWN_SECONDS = 1.25
    MCM_SAVE_RUNTIME_STATE = False
